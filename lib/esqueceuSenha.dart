          ...
          (
            ...
            (
              ...
              (
                children: 
                [
                  SizedBox(width: 250, child: Image.asset('assets/images/forgotpassword.png'),),
                  ...
                  Text("Informe o e-mail e inviaremos um código de verificação: "),
                  ...
                  (
                    onPressed: () {
                      bool isEmailValid = controlaEmail.text.isNotEmpty && controlaEmail.text.contains('@') && controlaEmail.text.contains('.com');
